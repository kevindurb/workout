...
func (h *Handler) show(w http.ResponseWriter, r *http.Request) (Node, error) {
	...
	exercises, _ := h.q.ListExercisesByWorkoutId(r.Context(), sqlcgen.ListExercisesByWorkoutIdParams{
	...
	return Layout(
		...
		Ul(
			Map(exercises, func(exercise sqlcgen.ListExercisesByWorkoutIdRow) Node {
...
func (h *Handler) create(w http.ResponseWriter, r *http.Request) {
	...
	workout, err := h.q.CreateWorkout(r.Context(), sqlcgen.CreateWorkoutParams{
		UserID: userID,
		Name:   data.Name,
	})
...
func (h *Handler) update(w http.ResponseWriter, r *http.Request) {
	...
	h.q.UpdateWorkout(r.Context(), sqlcgen.UpdateWorkoutParams{
		ID:     workout.ID,
		UserID: userID,
		Name:   data.Name,
	})
...
func (h *Handler) delete(w http.ResponseWriter, r *http.Request) {
	workout := middleware.FromContext[sqlcgen.Workout](r.Context())
	userID := h.sm.UserID(r.Context())
	h.q.DeleteWorkoutByID(r.Context(), sqlcgen.DeleteWorkoutByIDParams{
		ID:     workout.ID,
		UserID: userID,
	})
