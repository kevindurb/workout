...
func (h *Handler) Routes(r chi.Router) {
	...
	r.Route("/{exercise_id}", func(r chi.Router) {
		r.Use(middleware.EntityCtx(func(r *http.Request) (sqlcgen.Exercise, error) {
			return h.q.GetExerciseByID(r.Context(), sqlcgen.GetExerciseByIDParams{
				ID:     httpx.PathInt(r, "exercise_id"),
